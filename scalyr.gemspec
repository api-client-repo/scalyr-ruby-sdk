...
Gem::Specification.new do |s|
  s.name        = "scalyr"
  s.version     = Scalyr::VERSION
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["api-client-repo"]
  s.email       = ["api-client-repo@noreply.github.com"]
  s.homepage    = ""
  s.summary     = "Ruby SDK (beta) for scalyr API"
  s.description = "Ruby SDK (beta) for scalyr API"
